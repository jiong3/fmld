// Not tested or used, draft for a more compact representation of the dictionary
#![allow(clippy::all, clippy::pedantic, clippy::nursery, reason = "Generated by LLM, might never be used")]
